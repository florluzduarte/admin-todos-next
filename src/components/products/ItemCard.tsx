...
import * as shoppingActions from "../../shopping-cart/actions/shopping-actions";
...
export const ItemCard = ({ product, quantity }: Props) => {
  ...
  function handleAddToCart() {
    shoppingActions.addProductToCart(product.id);
    router.refresh();
  }

  function handleRemoveItem() {
    shoppingActions.removeSingleProductFromCart(product.id);
    router.refresh();
  }
